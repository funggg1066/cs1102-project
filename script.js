document.addEventListener('DOMContentLoaded', function() {
    ...
    const quizData = [
        {
            question: "1. What is the core objective of risk parity method?",
        ...
        {
            question: "2. In the simplified mean-variance model, the optimization problem primarily minimizes which one?",
        ...
        {
            question: "3. Which of the following robo-advisory systems most commonly used for initially assessing a user’s risk preference?",
        ...
        {
            question: "4. Which of the following constraint most directly reduce net returns when rebalancing occurs monthly in real life example?",
        ...
        {
            question: "5. A key advantage of equal weighting compared to mean-variance optimization is:",
